(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('primeng/primeng'), require('@angular/platform-browser'), require('@angular/router'), require('rxjs/Subject'), require('@angular/http'), require('ngx-cookie-service'), require('moment'), require('rxjs'), require('angular2-datatable')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', 'primeng/primeng', '@angular/platform-browser', '@angular/router', 'rxjs/Subject', '@angular/http', 'ngx-cookie-service', 'moment', 'rxjs', 'angular2-datatable'], factory) :
	(factory((global['w2020-shared-library'] = {}),global.core,global.common,global.forms,global.primeng,global.platformBrowser,global.router,global.Subject,global.http,global.ngxCookieService,global.moment,global.rxjs,global.angular2Datatable));
}(this, (function (exports,core,common,forms,primeng,platformBrowser,router,Subject,http,ngxCookieService,moment,rxjs,angular2Datatable) { 'use strict';

moment = moment && moment.hasOwnProperty('default') ? moment['default'] : moment;

var ShareDataService = (function () {
    function ShareDataService() {
        this.blockUISource = new Subject.Subject();
        this.showStatusMessage = new Subject.Subject();
        this.toggleSettingDiv = new Subject.Subject();
        ...
        this.showStatusMessage = new core.EventEmitter();
    }
    /**
     * @param {?} isBlockUI
     * @return {?}
...
var UtilService = (function () {
    ...
    function UtilService(messageService, shareDataService) {
        ...
        this.titleEmitter = new core.EventEmitter();
        this.helpDocUrlEmitter = new core.EventEmitter();
        /**
...
var ThemeService = (function () {
    ...
    function ThemeService(renderer, cookieService) {
        ...
        this.onThemeChanged = new core.EventEmitter();
    }
    /**
     * @param {?} themeValue
     * @return {?}
...
var NavbarComponent = (function () {
    ...
    function NavbarComponent(carouselService, utilService, themeService, router$$1, document, cookieService, shareDataService) {
        ...
        this.onClickTopBarCloseSideNavBar = new core.EventEmitter();
        this.toggleBlockUI = new core.EventEmitter();
...
NavbarComponent.decorators = [
    { type: core.Component, args: [{
                ...
                providers: [ThemeService, ngxCookieService.CookieService],
...
NavbarComponent.propDecorators = {
    'onClickTopBarCloseSideNavBar': [{ type: core.Output },],
    'toggleBlockUI': [{ type: core.Output },],
...
SideNavComponent.propDecorators = {
    'environment': [{ type: core.Input, args: ['environment',] },],
    'logoutBaseUrl': [{ type: core.Input, args: ['logoutBaseUrl',] },],
    'toggleBlockUI': [{ type: core.Output },],
...
var RefreshService = (function () {
    ...
    RefreshService.prototype.initialize = function () {
        var _this = this;
        rxjs.Observable.timer(RefreshService.TIMEOUT).subscribe(function () {
            if (_this.callback) {
                _this.callback();
            }
            _this.initialize();
...
var WinConfirmationComponent = (function () {
    ...
    function WinConfirmationComponent(modalService) {
        ...
        this.unconfirmed = new core.EventEmitter();
        this.backButton = new core.EventEmitter();
        /**
...
WinConfirmationComponent.propDecorators = {
    ...
    'button1': [{ type: core.Input, args: ['button1',] },],
    'button2': [{ type: core.Input, args: ['button2',] },],
    'model': [{ type: core.Input, args: ['model',] },],
    'confirmed': [{ type: core.Output },],
    'unconfirmed': [{ type: core.Output },],
    'backButton': [{ type: core.Output },],
};
...
var DATEPICKER_VALUE_ACCESSOR = {
    ...
    useExisting: core.forwardRef(function () { return WinDatepickerComponent; }),
    multi: true
};
...
var TIMEPICKER_VALUE_ACCESSOR = {
    provide: forms.NG_VALUE_ACCESSOR,
    useExisting: core.forwardRef(function () { return WinTimepickerComponent; }),
    multi: true
};
...
WinTimepickerComponent.propDecorators = {
    'id': [{ type: core.Input, args: ['id',] },],
    'clearOnTab': [{ type: core.Input, args: ['clearOnTab',] },],
    'initialValue': [{ type: core.Input, args: ['initialValue',] },],
...
var WinGridComponent = (function () {
    function WinGridComponent() {
        ...
        this.elementSelected = new core.EventEmitter();
        this.layoutUpdated = new core.EventEmitter();
        this.creating = false;
        this.dragging = false;
        this.squares = [];
    }
...
WinGridComponent.propDecorators = {
    'TOTAL_COLUMNS': [{ type: core.Input, args: ['columns',] },],
    'TOTAL_ROWS': [{ type: core.Input, args: ['rows',] },],
    'SQUARE_SIZE': [{ type: core.Input, args: ['squareSize',] },],
    'LINE_SIZE': [{ type: core.Input, args: ['lineSize',] },],
    'LINE_COLOR': [{ type: core.Input, args: ['lineColor',] },],
    'GRID_COLOR': [{ type: core.Input, args: ['gridColor',] },],
    'colorScheme': [{ type: core.Input, args: ['colorScheme',] },],
    'initialized': [{ type: core.Output },],
    'elementSelected': [{ type: core.Output },],
    'layoutUpdated': [{ type: core.Output },],
};
...
var WinPaginationComponent = (function () {
    ...
    function WinPaginationComponent(utilService) {
        ...
        this.winPageSizeChanged = new core.EventEmitter();
        this.winPageChanged = new core.EventEmitter();
        this.page = 1;
    }
    /**
...
WinPaginationComponent.propDecorators = {
    'id': [{ type: core.Input, args: ['id',] },],
    'showPageSize': [{ type: core.Input, args: ['showPageSize',] },],
    'currentPageSize': [{ type: core.Input, args: ['pageSize',] },],
    'winPageSizeChanged': [{ type: core.Output, args: ['winPageSizeChanged',] },],
    'currentPage': [{ type: core.Input, args: ['currentPage',] },],
    'winPageChanged': [{ type: core.Output, args: ['winPageChanged',] },],
    'totalItems': [{ type: core.Input, args: ['totalItems',] },],
...
WinSorterComponent.ctorParameters = function () { return [
    { type: angular2Datatable.DataTable, },
]; };
WinSorterComponent.propDecorators = {
    'sortBy': [{ type: core.Input, args: ['by',] },],
...
UpperCaseDirective.decorators = [
    { type: core.Directive, args: [{ selector: '[uppercase]' },] },
];
/**
 * @nocollapse
 */
...
var TYPEAHEAD_VALUE_ACCESSOR = {
    provide: forms.NG_VALUE_ACCESSOR,
    multi: true,
    useExisting: core.forwardRef(function () { return WinTypeaheadComponent; })
};
var WinTypeaheadComponent = (function () {
    function WinTypeaheadComponent() {
        ...
        this.searchEvent = new core.EventEmitter(); // Event to be fired when user searches something
        this.enter = new core.EventEmitter(); // Event to be fired when user press enter key
        this.onChange = function () { };
        this.onTouched = function () { };
...
WinChipsComponent.propDecorators = {
    'limit': [{ type: core.Input, args: ['limit',] },],
    'list': [{ type: core.Input, args: ['list',] },],
    'removeItem': [{ type: core.Output, args: ['removeItem',] },],
};
...
WinSelectComponent.decorators = [
    { type: core.Component, args: [{
                ...
                providers: [
                    {
                        provide: forms.NG_VALUE_ACCESSOR,
                        useExisting: core.forwardRef(function () { return WinSelectComponent; }),
                        multi: true
                    },
                    {
                        provide: forms.NG_VALIDATORS,
...
WinSelectComponent.propDecorators = {
    ...
    'disabled': [{ type: core.Input },],
    'id': [{ type: core.Input },],
    'contentCenter': [{ type: core.Input },],
    'defaultOption': [{ type: core.Input },],
    'searchInput': [{ type: core.ViewChild, args: ['searchInput',] },],
    'onChange': [{ type: core.Output },],
    'closeDropdown': [{ type: core.HostListener, args: ['document:click', ['$event'],] },],
};
...
exports.SharedLibraryModule = SharedLibraryModule;
exports.NavbarComponent = NavbarComponent;
exports.SideNavComponent = SideNavComponent;
exports.WinConfirmationComponent = WinConfirmationComponent;
exports.BS4WinConfirmationComponent = BS4WinConfirmationComponent;
exports.DATEPICKER_VALUE_ACCESSOR = DATEPICKER_VALUE_ACCESSOR;
exports.DATEPICKER_VALIDATORS = DATEPICKER_VALIDATORS;
exports.WinDatepickerComponent = WinDatepickerComponent;
exports.TIMEPICKER_VALUE_ACCESSOR = TIMEPICKER_VALUE_ACCESSOR;
exports.TIMEPICKER_VALIDATORS = TIMEPICKER_VALIDATORS;
exports.WinTimepickerComponent = WinTimepickerComponent;
exports.WinGridComponent = WinGridComponent;
exports.WinAlertComponent = WinAlertComponent;
exports.AlertType = AlertType;
exports.WinSorterComponent = WinSorterComponent;
exports.TYPEAHEAD_VALUE_ACCESSOR = TYPEAHEAD_VALUE_ACCESSOR;
exports.WinTypeaheadComponent = WinTypeaheadComponent;
exports.WinPaginationComponent = WinPaginationComponent;
exports.HelpDocComponent = HelpDocComponent;
exports.WinChipsComponent = WinChipsComponent;
exports.WinSelectComponent = WinSelectComponent;
exports.Address = Address;
exports.AltPartNumber = AltPartNumber;
exports.Bin = Bin;
exports.BinCombination = BinCombination;
exports.BinCondition = BinCondition;
exports.BinItemCombination = BinItemCombination;
exports.BinItemInfo = BinItemInfo;
exports.BinItemLocation = BinItemLocation;
exports.BinLocation = BinLocation;
exports.BinItemDetails = BinItemDetails;
exports.BinType = BinType;
exports.BinlocationAndItemCreate = BinlocationAndItemCreate;
exports.BinLocationFieldSync = BinLocationFieldSync;
exports.DeliverableOrder = DeliverableOrder;
exports.DeliverableOrderItem = DeliverableOrderItem;
exports.DeliverableOrderPhoto = DeliverableOrderPhoto;
exports.DeliverableOrderStatus = DeliverableOrderStatus;
exports.Driver = Driver;
exports.Item = Item;
exports.ItemBinCombination = ItemBinCombination;
exports.ItemCombination = ItemCombination;
exports.ItemBinDetails = ItemBinDetails;
exports.GridColorScheme = GridColorScheme;
...
exports.NotDeliveredOrder = NotDeliveredOrder;
exports.PickVia = PickVia;
exports.PurchaseOrder = PurchaseOrder;
exports.PurchaseOrderItem = PurchaseOrderItem;
exports.QuantityAdjustNote = QuantityAdjustNote;
exports.QuantityAdjustReason = QuantityAdjustReason;
exports.ReceiveVia = ReceiveVia;
exports.Signature = Signature;
exports.Stop = Stop;
exports.StopStatus = StopStatus;
exports.Truck = Truck;
exports.Zone = Zone;
exports.ZoneDetails = ZoneDetails;
exports.BinItemTransfer = BinItemTransfer;
exports.WinResponse = WinResponse;
